...
const insertUser = (sql1 , sql2 , params1 , params2) => new Promise((resolve, reject) =>{
    res = {
        values: [],
        status: true
    }
...
const update = (sql , params) => new Promise((resolve, reject) =>{
    res = {
        values: [],
        status: true
    }
...
const remove = (sql , params) => new Promise((resolve, reject) => {
    res = {
        values: [],
        status: true
    }
